...
public class RTestREDEditorFileIO extends RTestREDEditor {
	...
	private static final String LONG_TEXT = new String("The Balrog reached the bridge."
	 ...
	 */
	private void test2EditorTextSharing(REDEditor editor, String content) {
...
//		test2EditorTextSharing(editor2, LONG_TEXT);
	 ...
	 */
	public void testSaveWithBackup() throws FileNotFoundException, IOException {
		// configure logging
		logEventClass(REDTextEventListener.class);
		logEventClass(REDEditorEventListener.class);
		ignoreEventMethod("getListenerLevel");
	 ...
	 * <CODE>isModified</CODE> is tested.
	 */
	public void testSaveWithoutBackup() throws FileNotFoundException, IOException {
		// configure logging
		logEventClass(REDTextEventListener.class);
		logEventClass(REDEditorEventListener.class);
		ignoreEventMethod("getListenerLevel");
	 ...
	 * tested.
	 */
	public void testSaveFileAs() throws FileNotFoundException, IOException {
		// configure logging
		logEventClass(REDTextEventListener.class);
		logEventClass(REDEditorEventListener.class);
		ignoreEventMethod("getListenerLevel");
	...
	public void testSaveFileAsWithOpenTarget() throws FileNotFoundException, IOException {
	 ...
	 */
	public void testSaveEmergency() throws FileNotFoundException, IOException {
		// configure logging
		logEventClass(REDTextEventListener.class);
		logEventClass(REDEditorEventListener.class);
		ignoreEventMethod("getListenerLevel");
	...
	private void insertText(REDEditor editor) {
		String result = INS_TEXT + TEXT_CONTENT;
	...
	class TestPlugin extends REDPlugin {
