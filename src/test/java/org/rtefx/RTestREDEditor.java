...
public class RTestREDEditor extends TestCase {
	...
	static final String TEXT_CONTENT = new String("Don't meddle in the affairs of wizards,"
	...
	void checkEvents(String expLog) {
		assertEquals("View Listener", expLog, "" + fViewProxy);
		assertEquals("Normal Listener", expLog, "" + fNormalProxy);
		assertEquals("Late Listener", expLog, "" + fLateProxy);
	}
