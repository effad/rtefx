...
public class PTestREDText {
	...
	static public void testInsertEnd() throws REDException {
	...
	static public void testLoadLarge() throws REDException {
		REDText t = new REDText("");
		PTestStopWatch sw = new PTestStopWatch();
		sw.start();
		for (int x = 0; x < iterations; x++) {
	...
	static public void testFileLength() throws FileNotFoundException, IOException {
	...
	static public void testRandomAccessFile() throws FileNotFoundException, IOException {
		RandomAccessFile rf = new RandomAccessFile("PTestREDText.1.in", "r");
		PTestStopWatch sw = new PTestStopWatch();
	...
	static public void  main(String args[]) throws REDException, FileNotFoundException, IOException {
		try {
		...
		if (test.equals("InsertEnd")) {
			testInsertEnd();
		}
		else if (test.equals("LoadLarge")) {
			testLoadLarge();
		}
		else if (test.equals("FileLength")) {
			testFileLength();
		}
		else if (test.equals("ReadByte")) {
