...
/** Interactive testbed for editor classes, using Swing internal frames.
  * @author rli@chello.at
  * @tier test
  */
public class OTestIntFrame extends REDEventAdapter {
	public OTestIntFrame(String [] args) {
		String name = "";
		if (args.length > 0) {
			name = args[0];
		}
...
//		v.setBorder(BorderFactory.createMatteBorder(20, 50, 20, 50, Color.gray.darker()));
		...
		fFrame.setContentPane(fDesktop);
//		fFrame.getContentPane().add(new JTextField("Some bla", 80), BorderLayout.NORTH);
//		fFrame.getContentPane().add(new JScrollPane(v), BorderLayout.CENTER);
//		setupFindReplace();
...
//	}
	...
	public static void main(String[] args) throws InterruptedException {
		OTestIntFrame ote = new OTestIntFrame(args);
...
//				REDGLog.info("OTestIntFrame", "Loading file took: " + (end - start) + " msec.");
//			}
//		};
//		menuItem = menu.add(action);
//
...
//		addPluginMenuEntry(menu, "Auto-Indentation", "org.rtefx.plugins.REDAutoIndent");
//		addPluginMenuEntry(menu, "Emergency Auto-Save", "org.rtefx.plugins.REDAutoSave");
...
//				REDGLog.info("OTestIntFrame", "Protecting lines: " + start + " to " + end);
...
//		setTitle();
	...
	class UndoRedoUpdater extends REDEventAdapter {
