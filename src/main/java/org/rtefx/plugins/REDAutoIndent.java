...
public class REDAutoIndent extends REDPlugin {
	...
	class REDAutoIndentController extends REDViewControllerDecorator {
		...
		private REDAutoIndent fIndent;
		private Pattern fRexOpen, fRexClose;
	...
	private boolean containsOnly(String haystack, String needles) {
		return findFirstNotOf(haystack, needles) == -1;
	}

	private int findFirstNotOf(String haystack, String needles) {
		int i = 0;
